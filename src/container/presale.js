                        ...
                        <div className="row d-grid mb-4">
                            ...
                            <div className="col-md-8 pt-2">
                                <div className='border border-warning round-border text-center justify-content-center pt-5 pb-5 parent-div'>
                                    ...
                                    <h6 className='text-white text-break font-weight-normal text-center'>Purchase from 0.01 to 2 BNB</h6>
                                    <h6 className='text-white text-break font-weight-normal text-center mb-3'>Rate is 1 BNB = 550,000</h6>
                                    <button className='text-uppercase color-button' onClick={() => buyTokens(bnbAmount)}> pre-sales</button>
                                </div>
                            </div>
